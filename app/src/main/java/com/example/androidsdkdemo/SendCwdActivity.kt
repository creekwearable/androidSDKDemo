    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cmd.setOnClickListener {
            ...
            when (value) {
                ...
                "Contacts query" -> {
                    CreekManager.sInstance.getContacts({
                            model: Contacts.protocol_frequent_contacts_inquire_reply ->
                        textView.text = model.toString()
                    }, failure = {
                            _,m ->
                        textView.text = m
                ...
                "Query activity data" -> {
                    CreekManager.sInstance.getActivityNewTimeData(startTime = "2023-08-01", endTime = "2023-09-01") {
                ...
                "Query sleep data" -> {
                    CreekManager.sInstance.getSleepNewTimeData(startTime = "2023-08-01", endTime = "2023-09-01") {
                ...
                "Query heart rate data" -> {
                    CreekManager.sInstance.getHeartRateNewTimeData(startTime = "2023-08-01", endTime = "2023-09-01") {
                ...
                "Query pressure data" -> {
                    CreekManager.sInstance.getStressNewTimeData(startTime = "2023-08-01", endTime = "2023-09-01") {
                ...
                "Range query exercise record" -> {
                    CreekManager.sInstance.getSportTimeData(startTime = "2023-08-01", endTime = "2023-09-01", type = null) {
                            model: BaseModel<Array<SportModel>> ->
                        textView.text = model.data?.toList().toString()
